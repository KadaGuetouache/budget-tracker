...
const DeleteTransactionDialog = ({ open, setOpen, transactionId }: Props) => {
  ...
  const deleteMutation = useMutation({
    ...
    onSuccess: async () => {
      sonner.success("Transaction  deleted successfully", { id: transactionId })
    ...
    onError: () => {
      sonner.error("Something went wrong!", { id: transactionId })
    }
  })
      ...
      <AlertDialogContent>
        ...
        <AlertDialogFooter>
          ...
          <AlertDialogAction onClick={() => {
            sonner.loading("Deleting transaction ...", { id: transactionId })
