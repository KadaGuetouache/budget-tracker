...
const History = ({ userSettings }: { userSettings: UserSettings | null }) => {
        ...
        <CardHeader className="gap-2">
          <CardTitle className="grid grid-flow-row justify-between gap-2 md:grid-flow-col">
            ...
            <div className="flex h-10 gap-2">
              ...
              <Badge variant={"outline"} className="flex items-center gap-2 text-sm">
                <div className="h-4 w-4 rounded-full bg-red-500"></div>Expense
              </Badge>
            </div>
          </CardTitle>
        </CardHeader>
...
function TooltipRow({ label, value, bgColor, textColor, formatter }: TooltipRowTypes) {
